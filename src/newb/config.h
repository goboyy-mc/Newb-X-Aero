...
#define NL_NIGHT_MOONLIGHT_COL vec3(0.014,0.028,0.15)
...
/* Aurora settings */
#define NL_AURORA 0.35           // [toggle] 0.4 dim ~ 4.0 very bright
...
/* Galaxy */
#define NL_GALAXY_STARS 1.30           // [toggle] 0.1 dim - 4.0 bright
