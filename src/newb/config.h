...
#define NL_NETHER_AMBIENT vec3(2.90,2.05,1.82)
#define NL_END_AMBIENT    vec3(1.75,1.38,2.65)

/* Sun/moon light color */
#define NL_DAWN_SUNLIGHT_COL   vec3(1.20,0.52,0.22)
#define NL_NOON_SUNLIGHT_COL   vec3(0.96,0.98,1.08)
#define NL_NIGHT_MOONLIGHT_COL vec3(0.015,0.03,0.16)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.00,0.48,0.18)
#define NL_UNDERWATER_TORCH_COL vec3(1.00,0.48,0.18)
#define NL_NETHER_TORCH_COL     vec3(1.00,0.48,0.18)
...
#define NL_SKY_VOID_DARKNESS   0.48
...
#define NL_DAY_ZENITH_COL    vec3(0.22,0.72,2.25)
#define NL_DAY_HORIZON_COL   vec3(0.92,1.58,2.05)
...
#define NL_RAINBOW_CLEAR 0.08 // 0.3 subtle ~ 1.0 bright during clear weather
#define NL_RAINBOW_RAIN  0.62 // 0.3 subtle ~ 1.0 bright during rain weather

/* Ore glow intensity */
#define NL_GLOW_TEX 2.60           // 0.4 weak ~ 8.0 bright
#define NL_GLOW_SHIMMER 0.65       // [toggle] 0.1 subtle ~ 1.0 100% shimmer
#define NL_GLOW_SHIMMER_SPEED 0.70 // 0.5 slow - 2.0 fast
...
#define NL_LANTERN_WAVE 0.10   // [toggle] 0.05 subtle ~ 0.4 large swing
...
/* Soft cloud settings */
#define NL_CLOUD1_SCALE vec2(0.014, 0.020) // 0.003 large ~ 0.2 tiny
#define NL_CLOUD1_DEPTH 1.10                // 0.0 no bump ~ 10.0 large bumps
#define NL_CLOUD1_SPEED 0.03               // 0.0 static ~ 0.4 fast moving
#define NL_CLOUD1_DENSITY 0.48             // 0.1 less clouds ~ 0.8 more clouds
#define NL_CLOUD1_OPACITY 0.94              // 0.0 invisible ~ 1.0 opaque

/* Rounded cloud settings */
#define NL_CLOUD2_THICKNESS 2.30            // 0.5 slim ~ 5.0 fat
#define NL_CLOUD2_RAIN_THICKNESS 2.80       // 0.5 slim ~ 5.0 fat
#define NL_CLOUD2_STEPS 6                  // 3 low quality ~ 16 high quality
#define NL_CLOUD2_SCALE vec2(0.030, 0.030) // 0.003 large ~ 0.3 tiny
#define NL_CLOUD2_SHAPE vec2(0.48, 0.42)     // 0.0 round ~ 1.0 box vec2(horizontal shape, vertical shape)
#define NL_CLOUD2_DENSITY 28.0             // 1.0 blurry ~ 100.0 sharp
#define NL_CLOUD2_VELOCITY 0.70             // 0.0 static ~ 4.0 very fast
...
/* Aurora settings */
#define NL_AURORA 0.70           // [toggle] 0.4 dim ~ 4.0 very bright
...
#define NL_SHOOTING_STAR_DELAY 52.0 // 0.0 no delay ~ 100.0 long time (100 secs)

/* Galaxy */
#define NL_GALAXY_STARS 1.40           // [toggle] 0.1 dim - 4.0 bright
#define NL_GALAXY_VIBRANCE 0.90          // 0.0 white - 1.0 colorful
...
/* Sun/Moon */
#define NL_SUN_SIZE  1.10           // 0.3 tiny ~ 4.0 massive
#define NL_MOON_SIZE 1.10           // 0.3 tiny ~ 4.0 massive
...
/* Sky reflection */
#define NL_GROUND_REFL 0.22       // [toggle] 0.2 slightly reflective ~ 1.0 fully reflect sky
#define NL_GROUND_RAIN_WETNESS 1.0 // 0.0 no wetness ~ 1.0 fully wet blocks when raining
#define NL_GROUND_RAIN_PUDDLES 0.72 // 0.0 no puddles ~ 1.0 puddles
...
/* Weather particles */
#define NL_WEATHER_SPECK 0.72         // [toggle] 0.0 vanilla texture ~ 1.0 soft speck
#define NL_WEATHER_RAIN_SLANT 3.60    // 1.0 minimal ~ 8.0 violent
#define NL_WEATHER_PARTICLE_SIZE 0.92 // 0.5 tiny ~ 4.0 large
...
#define NL_LAVA_NOISE_SPEED 0.16  // 0.0 still ~ 0.8 fast
