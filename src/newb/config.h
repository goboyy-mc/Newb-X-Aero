...
#define NL_SHADOW_INTENSITY     0.60  // 0.0 no shadow ~ 1.0 strong shadow
...
#define NL_GLOW_SHIMMER 0.60       // [toggle] 0.1 subtle ~ 1.0 100% shimmer
#define NL_GLOW_SHIMMER_SPEED 0.80 // 0.5 slow - 2.0 fast
...
#define NL_UNDERWATER_TINT vec3(0.40,0.85,0.75) // fog tint color when underwater
...
/* Soft cloud settings */
#define NL_CLOUD1_SCALE vec2(0.015, 0.020) // 0.003 large ~ 0.2 tiny
...
/* Aurora settings */
#define NL_AURORA 0.4           // [toggle] 0.4 dim ~ 4.0 very bright
...
#define NL_AURORA_COL1 vec3(0.22,0.90,0.78)
#define NL_AURORA_COL2 vec3(0.42,0.30,1.00)

#define NL_CLOUD_AURORA_REFLECTION // [toggle] simple clouds/aurora reflection

/* Shooting star */
#define NL_SHOOTING_STAR 0.65        // [toggle] 0.2 dim ~ 1.0 bright
...
#define NL_GALAXY_VIBRANCE 0.40          // 0.0 white - 1.0 colorful
...
#define NL_ENTITY_EDGE_HIGHLIGHT 0.70 // [toggle] 0.0 no highlight ~ 1.6 bright highlight
