...
#define NL_SHADOW_INTENSITY     0.65  // 0.0 no shadow ~ 1.0 strong shadow
...
#define NL_NETHER_AMBIENT vec3(3.10,2.20,1.90)
#define NL_END_AMBIENT    vec3(1.60,1.45,2.55)
...
/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.00,0.58,0.22)
#define NL_UNDERWATER_TORCH_COL vec3(1.00,0.58,0.22)
#define NL_NETHER_TORCH_COL     vec3(1.00,0.58,0.22)
...
#define NL_SKY_RAIN_MIX_FACTOR 0.78
...
#define NL_RAIN_ZENITH_COL   vec3(0.38,0.50,0.66)
#define NL_RAIN_HORIZON_COL  vec3(0.70,0.78,0.86)

#define NL_END_ZENITH_COL    vec3(0.12,0.08,0.32)
#define NL_END_HORIZON_COL   vec3(0.46,0.26,0.82)


/* Rainbow */
#define NL_RAINBOW           // [toggle] enable rainbow in sky
#define NL_RAINBOW_CLEAR 0.05 // 0.3 subtle ~ 1.0 bright during clear weather
#define NL_RAINBOW_RAIN  0.18 // 0.3 subtle ~ 1.0 bright during rain weather

/* Ore glow intensity */
#define NL_GLOW_TEX 2.50           // 0.4 weak ~ 8.0 bright
#define NL_GLOW_SHIMMER 0.45       // [toggle] 0.1 subtle ~ 1.0 100% shimmer
...
#define NL_LANTERN_WAVE 0.09   // [toggle] 0.05 subtle ~ 0.4 large swing
...
#define NL_CLOUD2_SHAPE vec2(0.50, 0.42)     // 0.0 round ~ 1.0 box vec2(horizontal shape, vertical shape)
#define NL_CLOUD2_DENSITY 24.0             // 1.0 blurry ~ 100.0 sharp
#define NL_CLOUD2_VELOCITY 0.65             // 0.0 static ~ 4.0 very fast
...
#define NL_ENTITY_EDGE_HIGHLIGHT 0.30 // [toggle] 0.0 no highlight ~ 1.6 bright highlight

/* Weather particles */
#define NL_WEATHER_SPECK 0.75         // [toggle] 0.0 vanilla texture ~ 1.0 soft speck
#define NL_WEATHER_RAIN_SLANT 2.8    // 1.0 minimal ~ 8.0 violent
#define NL_WEATHER_PARTICLE_SIZE 0.90 // 0.5 tiny ~ 4.0 large
